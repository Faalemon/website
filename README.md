...
- 客户端下载:
	...
	- [快柠檬Linux安装包 v1.11.5009 (.deb, Ubuntu/Debian 桌面)](https://github.com/Faalemon/website/releases/latest/download/Falemon-linux-x64-1.11.5009.deb)
	- [快柠檬Linux安装包 v1.11.5009 (.tar.gz, 通用)](https://github.com/Faalemon/website/releases/latest/download/Falemon-linux-x64-1.11.5009.tar.gz)
